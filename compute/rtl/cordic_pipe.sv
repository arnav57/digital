...
module cordic_pipe #(
    parameter int NUM_STAGES      = 14,  // What stage in the pipeline is this current unit?
...
localparam logic signed [15:0] theta_values [0:13] = '{
    ...
    16'sd1359,  // atan(2^-3)  =  7.125016°
    16'sd682,   // atan(2^-4)  =  3.576334°
    16'sd341,   // atan(2^-5)  =  1.789911°
    16'sd171,   // atan(2^-6)  =  0.895174°
    16'sd85,    // atan(2^-7)  =  0.447614°
    16'sd43,    // atan(2^-8)  =  0.223811°
    16'sd21,    // atan(2^-9)  =  0.111906°
    16'sd11,    // atan(2^-10) =  0.055953°
